...
resp.bin.mat.npsp<-read.csv("//Users/TScott/Google Drive/PSP_Project/PS_Data/Shared.Groups.Npsp.csv")


dim(resp.bin.mat)

sum(read.csv("//Users/TScott/Google Drive/PSP_Project/PS_Data/Shared.Groups.Psp.csv")[,-1])
sum(read.csv("//Users/TScott/Google Drive/PSP_Project/PS_Data/Shared.Groups.Npsp.csv")[,-1])
sum(read.csv("//Users/TScott/Google Drive/PSP_Project/PS_Data/Shared.Groups.csv")[,-1])
