...
Long.Data1<-read.csv("//Users/TScott/Google Drive/PSP_Project/PS_Data/Final_Verbose.csv",header=T,sep=",")
Short.Data1<-read.csv("//Users/TScott/Google Drive/PSP_Project/PS_Data/Final_Scrubbed.csv",header=T)
SD<-Short.Data1
...
Group.Membership.Dat<-read.csv("//Users/TScott/Google Drive/PSP_Project/PS_Data/Group.Membership.Dat.csv",row.names=1)

Gmem.dat<-read.csv("//Users/TScott/Google Drive/PSP_Project/PS_Data/Group.Member.Dat.csv",row.names=1,header=T)
Grea.dat<-read.csv("//Users/TScott/Google Drive/PSP_Project/PS_Data/Group.Reason.Dat.csv",row.names=1,header=T)
Gpar.dat<-read.csv("//Users/TScott/Google Drive/PSP_Project/PS_Data/Group.Part.Dat.csv",row.names=1,header=T)

Org.Reps.dat<-read.csv("//Users/TScott/Google Drive/PSP_Project/PS_Data/Org.Dat.csv",row.names=1,header=T)
...
write.csv(Group.All,file="//Users/TScott/Google Drive/PSP_Project/PS_Data/Group.All.Dat.csv")
