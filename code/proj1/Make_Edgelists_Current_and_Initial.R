...
Wide.Data<-read.csv("//Users/TScott/Google Drive/elwha/Final_Verbose.csv",header=T,sep=",")
Short.Data<-read.csv("//Users/TScott/Google Drive/elwha/Final_Scrubbed.csv",header=T)
SD<-Short.Data
...
dat4<-read.csv("//Users/TScott/Google Drive/elwha/Group.Member.Dat.csv",row.names=1,header=T)
temp1<-dat4[,-1]
names(temp1)
...
write.csv(tempdat,file="//Users/TScott/Google Drive/elwha/Response.Contact.Dat.csv")
...
write.csv(Edgelist.Dat,file="//Users/TScott/Google Drive/elwha/Edgelist.Dat.Good.csv")
...
write.csv(tempdat,file="//Users/TScott/Google Drive/elwha/Response.Contact.Dat_initnet.csv")
...
write.csv(Edgelist.Dat,file="//Users/TScott/Google Drive/elwha/Edgelist.Dat.Good_initnet.csv")
