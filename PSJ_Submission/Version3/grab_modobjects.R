...
mod_base = logLik.ergm(object = mod_base,control = control.settings,
                       add = TRUE,eval.loglik = TRUE,verbose=T)


mod_allpart = logLik.ergm(object = mod_allpart,control = control.settings,
                       add = TRUE,eval.loglik = TRUE,verbose=T)

mod_allpartquad = logLik.ergm(object = mod_allpartquad,control = control.settings,
                          add = TRUE,eval.loglik = TRUE,verbose=T)

mod_dirpart = logLik.ergm(object = mod_dirpart,control = control.settings,
                          add = TRUE,eval.loglik = TRUE,verbose=T)

mod_indpart = logLik.ergm(object = mod_indpart,control = control.settings,
                          add = TRUE,eval.loglik = TRUE,verbose=T)

mod_shapart = logLik.ergm(object = mod_shapart,control = control.settings,
                          add = TRUE,eval.loglik = TRUE,verbose=T)

modpast_allpart7= logLik.ergm(object = modpast_allpart7,control = control.settings,
                          add = TRUE,eval.loglik = TRUE,verbose=T)
